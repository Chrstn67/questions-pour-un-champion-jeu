    ...
    <section>
      ...
      <main className="mentions">
        <p>
          ...
          https://chrstn67.github.io/QPUC l'identité des différents intervenants
          dans le cadre de sa réalisation et de son suivi: Propriétaire du site
          : Christian HUMBERT - Contact : chrstn.hmbrt67@outlook.com - Hébergeur
          : GitHub
        </p>

        <p>
          2 - Propriété intellectuelle et contrefaçons : Christian HUMBERT est
          ...
          autorisation écrite préalable de Christian HUMBERT. Toute exploitation
        ...
        <p>
          3 - Limitations de responsabilité : Christian HUMBERT ne pourra être
          tenu pour responsable des dommages directs et indirects causés au
          matériel de l’utilisateur, lors de l’accès au site
          https://chrstn67.github.io/QPUC. Christian HUMBERT décline toute
          responsabilité quant à l’utilisation qui pourrait être faite des
          informations et contenus présents sur https://chrstn67.github.io/QPUC.
          Christian HUMBERT s’engage à sécuriser au mieux le site
          https://chrstn67.github.io/QPUC, cependant sa responsabilité ne pourra
          être mise en cause si des données indésirables sont importées et
          installées sur son site à son insu. Des espaces interactifs (espace
          contact) sont à la disposition des utilisateurs. Christian HUMBERT se
          ...
          protection des données. Le cas échéant, Christian HUMBERT se réserve
        ...
        <p>
          ...
          du site https://chrstn67.github.io/QPUC dispose d’un droit d’accès, de
          modification et de suppression des informations collectées. Pour
          exercer ce droit, envoyez un message à notre Délégué à la Protection
          des Données : Christian HUMBERT - chrstn.hmbrt67@outlook.com.
        </p>

        <p>
          5 - Liens hypertextes et cookies : Le site
          https://chrstn67.github.io/QPUC contient des liens hypertextes vers
          d’autres sites et dégage toute responsabilité à propos de ces liens
          externes ou des liens créés par d’autres sites vers
          https://chrstn67.github.io/QPUC.
        </p>

        <p>
          6 - Droit applicable et attribution de juridiction : Tout litige en
          relation avec l’utilisation du site https://chrstn67.github.io/QPUC
